...
var getRandomIndex = function getRandomIndex(currentIndex, length) {
  var newIndex;
  do {
...
var moveGoblin = function moveGoblin() {
  var cells = document.querySelectorAll(".cell");
  var goblin = document.getElementById("goblin");
  var currentCell = Array.from(cells).findIndex(function (cell) {
    return cell.contains(goblin);
  });
  var newIndex = getRandomIndex(currentCell, cells.length);
